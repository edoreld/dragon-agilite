...
public class US02Test
{
	...
	public void l_utilisateur_souhaite_vérifier_une_caisse_dans_un_magasin() throws Exception {
		...
		caisse1 = new Caisse("caisse1", 70, magasin1);
		caisse2 = new Caisse("caisse2", 70, magasin2);
	...
	public void la_caisse_est_attribuer_dans_ce_Magsin() throws Exception {
		...
		assertEquals(false, magasin1.testRelation(caisse1)); // permet de
																...
																// existe dans
																// magasin1
		assertEquals(false, magasin1.testRelation(caisse2));
	...
	public void l_utilisateur_décide_de_vérifier_si_la_caisse_est_ouverte_ou_pas() throws Exception {
		...
		caisse1 = new Caisse("c1", 40, magasin1);
	}
	...
	public void l_état_de_la_caisse_est_renvoyée() throws Exception {
		...
		if (caisse2.getPanne() >= 80) { // true = en panne // false == elle
										// n'est pas en panne
			assertEquals(true, caisse2.caissePanne()); // la caisse est en panne
		} else {
			assertEquals(false, caisse2.caissePanne()); // la caisse n`est pas
														// en panne
		}
	...
	public void la_caisse_est_réparé() throws Exception {
		...
		assertEquals(false, caisse2.caissePanne()); // qui veut dire que la
													// caisse n'est pas en panne
	}
